...
const questions = [
  ...
  },
  {
    ...
    default: ({ dockerContainerName }) =>
      `registry.gitlab.com/${dockerContainerName}/${dockerContainerName}:latest`,
  },
  {
    type: 'input',
    name: 'version',
...
(async () => {
  ...
  console.log(
    results
      ...
      .map(result => `    \x1b[32m ${result.file} \x1b[0m`)
      .join('\n'),
  );
  console.log(
    answers.createDotEnv ? 'Created .env file' : '.env file not created',
  );
})();
